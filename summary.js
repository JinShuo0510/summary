          ...
          const tlReferer = `https://${window.location.host}/`;
                ...
                function ensureAIVisible() {
                        ...
                        if (aiExplanation) {
                                ...
                                aiExplanation.style.visibility = 'visible';
                                aiExplanation.style.opacity = '1';
                                aiExplanation.style.height = 'auto';
                                aiExplanation.style.overflow = 'visible';
                        }
                        }

                ai_init();
                ensureAIVisible(); // 添加这行
